        ...
        <div className="flex items-start gap-16">
          <div className="flex-1">
            ...
            <div className="flex items-center gap-4 mt-6">
              ...
              src="https://github.com/dev-carol.png " 
              alt="imagem github"/>
              <div className="leading-relaxed">
                <strong className="font-bold text-2xl block"> Carol Santos</strong>
                <span className="text-gray-200 text-sm block">Desenvolvedor Jr</span>
              </div>
